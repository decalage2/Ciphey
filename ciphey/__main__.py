...
class Ciphey:
    ...
    def decrypt(self):
        ...
        filtered_hashes = list(filter_out_object.failed_hashes)
        filtered_list = filtered_hashes.append(list(filter_out_object.failed_encodings))
        ...
        for key, value in self.what_to_choose.items():
            for k, v in value.items():
                ...
                if v < 0.01 and k not in filtered_list:
